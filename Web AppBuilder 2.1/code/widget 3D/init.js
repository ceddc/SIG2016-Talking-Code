...
(function(argument) {
  ...
  if (!window.apiUrl) {
    ...
    resources = resources.concat([
      ...
      window.path + 'libs/bootstrap/css/bootstrap.css', // MVI : ajout du CSS Bootstrap
      /*'//maxcdn.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css',*/
      window.path + 'libs/Dojo-Bootstrap/assets/datepicker.css', // MVI : ajout du CSS du DatePicker
      /*'//xsokev.github.io/Dojo-Bootstrap/css/datepicker.css'*/
    ]);
    ...
    if (window.apiUrl.substr(window.apiUrl.length - 'arcgis-js-api/'.length,
      ...
      dojoConfig.packages = [{
        ...
        location: window.path + "fx3d/esri"
          ...
          // MVI : ajout de la lib JS Dojo Bootstrap
          // add Dojo-Bootstrap if you want to use bootstrap components
